					...
					<div class="box-body">
						...
						<hr>
							...
							<div class="form-group ">
								<label for="name" class="col-md-3 control-label">No Aset</label>
								<div class="col-md-7 col-sm-12 required"> 
									<select style="width:100%;"  class="form-control select2" data-live-search="true"  title="Pilih Aset" name="no_aset_replace" id="no_aset_replace"    >
										 <option value=""></option>
										<?php 
								...
								<div class="form-group">
									...
									<div class="col-md-7 required">
										<select style="width:100%;"  onchange="TampilNotes(this.value)" class="form-control select2"   title="Pilih Aset" name="status" id="status" >
											 <option value=""></option>
											<?php 
						 ...
						 <div id="divCheckedMonitor" style="display:none;">
								<div class="form-group ">
									...
									<div class="col-md-7"> 
									<select style="width:100%;"  class="form-control select2" data-live-search="true"  title="Pilih Monitor" name="id_monitor_replace" id="id_monitor_replace" >
											<option value=""></option>
											<?php 
								...
								<div class="form-group">
									<label for="category_id" class="col-md-3 control-label">Status</label>
									<div class="col-md-7 required">
										<select style="width:100%;"  onchange="TampilNotes(this.value)" class="form-control select2"  placeholder="Pilih Status" name="status_monitor" id="status_monitor" >
											 <option value=""></option>
											<?php 
												$res = $conn->query("SELECT * FROM status_labels");
												while($row = $res->fetch_assoc()){
