...
// getting total number records without any search
	...
	$sql.=" FROM data_karyawan 
		...
		Left join data_uker_bagian ON data_karyawan.kd_bag=data_uker_bagian.kd_bag where data_karyawan.organik like '%$back%'";	
...
if( !empty($requestData['search']['value']) ) {
    // if there is a search parameter
	 $sql1 = "SELECT data_karyawan.*,data_karyawan.kd_uker as kd_uker_karyawan, data_uker.kd_uker as kd_dep, data_uker.nama_uker as departemen, data_uker_bagian.kd_bag as kd_bagian, data_uker_bagian.nama_bag as bagian";
	$sql1.=" FROM data_karyawan 
		Left join data_uker ON data_karyawan.kd_uker=data_uker.kd_uker
   ...
   // $requestData['search']['value'] contains search parameter
    $sql1.="  where data_karyawan.organik like '%$back%' AND data_karyawan.nik LIKE '%".$requestData['search']['value']."%' ";
    $sql1.="OR data_karyawan.organik like '%$back%' AND data_karyawan.nama_karyawan LIKE '%".$requestData['search']['value']."%' ";
    $sql1.="OR data_karyawan.organik like '%$back%' AND data_uker.kd_uker LIKE '%".$requestData['search']['value']."%' ";
    $sql1.="OR data_karyawan.organik like '%$back%' AND data_uker.nama_uker LIKE '%".$requestData['search']['value']."%' ";
    $sql1.="OR data_karyawan.organik like '%$back%' AND data_uker_bagian.kd_bag LIKE '%".$requestData['search']['value']."%' ";
    $sql1.="OR data_karyawan.organik like '%$back%' AND data_uker_bagian.nama_bag LIKE '%".$requestData['search']['value']."%' ";
	...
	$sql2 = "SELECT data_karyawan.*,data_karyawan.kd_uker as kd_uker_karyawan, data_uker.kd_uker as kd_dep, data_uker.nama_uker as departemen, 
	data_uker_bagian.kd_bag as kd_bagian, data_uker_bagian.nama_bag as bagian";	
	$sql2.=" FROM data_karyawan 
		Left join data_uker ON data_karyawan.kd_uker=data_uker.kd_uker
		Left join data_uker_bagian ON data_karyawan.kd_bag=data_uker_bagian.kd_bag where  data_karyawan.organik like '%$back%'";
