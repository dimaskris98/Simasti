...
if(isset($_POST['karyawan-detail']))
			 {
				$back ='<a  href="organik" style="width: 100%;" class="btn btn-md btn-default hidden-print">Back</a>';
			}else
			{
				...
				<div class="table table-responsive">
					<table class="table table-striped">
						<tbody>
							...
							<tr>
								<td>Department</td><td><a href=""><?php echo $data['departemen']; ?></a></td>
							</tr>
							<tr>
								<td>Bagian</td><td><a href=""><?php echo $data['bagian']; ?></a></td>
							</tr>  
						</tbody>
					</table>
				</div>
					...
					<tbody>
						...
						<td>
							<form action="detail" method="post">
								<a name="tes" href="javascript:" onclick="parentNode.submit();"> '.$row1['no_aset'].'</a>
								<input type="hidden" name="aset-detail" value="'.$row1['no'].'"/> 
							</form>
						</td>
						<td>'.$row1['tahun'].'</td> 
						<td>'.$row1['model'].'</td>
