                             ...
                             <div class="tab-pane active" id="details">
                                 <div class="row">
                                     <div class="col-md-2 text-center">
                                         <?php if ($data['img'] == "") { ?>
                                             <img src="images/karyawan/default-sm.png" class="avatar img-circle hidden-print" style="width:150px; height:150px;">
                                         <?php } else { ?>
                                             <img src="images/karyawan/<?php echo $data['img']; ?>" class="avatar img-circle hidden-print" style="width:150px; height:150px;">
                                         <?php } ?>
                                         ...
                                         <div class="table table-responsive">
                                             <table class="table table-striped">
                                                 <tbody>
                                                     ...
                                                     <tr>
                                                         <td>Email</td>
                                                         <td><a href="mailto:<?php echo $data['email']; ?>"><?php echo $data['email']; ?></a>
                                                         </td>
                                                     </tr>
                                                     <tr>
                                                         <td>Phone</td>
                                                         <td><a href="tel:1-359-355-3264 x947"><?php echo $data['tlp']; ?></a>
                                                         </td>
                                                     </tr>
                                                     <tr>
                                                         <td>Department</td>
                                     ...
                                     <div class="col-md-2">
                                         ...
                                         <div class="col-md-12" style="padding-top: 5px;">
                                             <form role="form" action="" method="POST" enctype="multipart/form-data">
                                                 ...
                                                 <button type="submit" name="hapuskaryawan" onclick="return confirm('Anda yakin akan menghapus data <?php echo $data['nik']; ?>')" class="btn btn-md btn-warning hidden-print" style="width: 100%;">Delete</button>
                                             </form>
                             ...
                             <div class="tab-pane" id="asset_tab">
                                 ...
                                 <div class="box-body table-responsive">
                                     ...
                                     <form role="form" action="add" method="POST" enctype="multipart/form-data">
                                         <input type="hidden" name="nik" value="<?php echo $data['nik']; ?>">
                                         <button type="submit" name="checkinto" class="btn btn-primary btn-md">Distribusi
                                             Aset</button>
                                     </form>
                                     <br>
