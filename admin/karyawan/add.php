...
if (isset($_POST['savekaryawan'])) {
	...
	if (empty($kd_bag)) {
		$kd_uker = $_POST['departemen'];
		$unitkerja = mysqli_fetch_array(mysqli_query($conn, "SELECT * FROM  data_uker WHERE kd_uker= '$kd_uker'"));
	...
	if (empty($foto)) {
		...
		$sql = "insert into data_karyawan  VALUES ('$nik', '$nama', '$kd_uker', '$bag', '$dep', '$email', '$tlp', '$foto','$tipe')";
	} else {
		...
		if (move_uploaded_file($tmp, $path)) { // Cek apakah gambar berhasil diupload atau tidak
			...
			$sql = "insert into data_karyawan  VALUES ('$nik', '$nama', '$kd_uker', '$bag', '$dep', '$email', '$tlp', '$fotobaru','$tipe')";
		} else {
