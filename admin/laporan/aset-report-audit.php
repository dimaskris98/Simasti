...
if (isset($_POST['submit'])) {
	...
	$jumlahAll = mysqli_num_rows(mysqli_query($conn, $sql));
	...
	$title='<center>Laporan Audit Aset</center>';
	echo '<h2>'.$title.'</h2>';
	echo '<br>';
	echo $message='<p style="text-align:right;">audit tanggal : '.$tgl1.' s/d '.$tgl2.'</p>';
?> 
		<table id="" class="table table-bordered table-striped">
			...
			<tbody> 
				 <form  method="POST" action="">
							...
							<input type="hidden" name="submit1" value="<?=$jumlahPc?>"></input>
					...
					<tr>
						<td>All Aset <?=$jumlahAll?> Unit 
							<button type="submit" name="all" class="btn btn-primary btn-sm"><span >Detail</span></button> 
						</td>
						<td>Dekstop <?=$jumlahPc?> Unit 
							<button type="submit" name="cp" class="btn btn-primary btn-sm"><span >Detail</span></button> 
						</td>
						<td>Monitor <?=$jumlahMonitor?> Unit  
								<button type="submit" name="cm" class="btn btn-primary btn-sm"><span >Detail</span></button> 
						</td>
						<td>Laptop <?=$jumlahLaptop?> Unit  
								<button type="submit" name="nb" class="btn btn-primary btn-sm"><span >Detail</span></button> 
						</td>
						<td>Printer <?=$jumlahPrinter?> Unit  
								<button type="submit" name="pr" class="btn btn-primary btn-sm"><span >Detail</span></button> 
						</td>
						<td>Proyektor <?=$jumlahProyektor?> Unit  
								<button type="submit" name="pj" class="btn btn-primary btn-sm"><span >Detail</span></button> 
						</td>
						<td>Printer-Scanner <?=$jumlahPrintScan?> Unit  
								<button type="submit" name="ps" class="btn btn-primary btn-sm"><span >Detail</span></button> 
						</td>
					</tr>
				 </form>
			</tbody> 
...
<?php
 ...
 if (isset($_POST['all'])) {
	...
	$query=mysqli_query($conn, $sql);
	 $title='<center>Data Semua Aset</center>';
	echo '<h2>'.$title.'</h2>';
	echo '<br>';
...
<table id="" class="table table-bordered table-striped">
			...
			<tbody> 
				 <form  method="POST" action="">
							<input type="hidden" name="sql" value="<?=$sql?>"></input>
							<input type="hidden" name="tgl" value="<?=$tgl?>"></input>
							<input type="hidden" name="submit1" value="<?=$jumlahAll?>"></input>
							<input type="hidden" name="cp1" value="<?=$jumlahPc?>"></input>
							<input type="hidden" name="cm1" value="<?=$jumlahMonitor?>"></input>
							<input type="hidden" name="nb1" value="<?=$jumlahLaptop?>"></input>
							<input type="hidden" name="pr1" value="<?=$jumlahPrinter?>"></input>
