...
<div class="table-responsive bs-example widget-shadow">
	<h4>DISTRIBUSI ASSET</h4>
		...
		<div class="col-md-5">
			<label for="model_number" >Tabel kebutuhan</label>
			<input  type="checkbox" value="kebutuhan" name="penggantianmonitor" id="penggantianmonitor"  onclick="ShowIfCheckedMonitor()" />
		</div>
	</form> 					 
<div class="row">
 <div class="col-md-6">	 
...
?>
			<tr>
				<td><a   href="#<?=$rowbag['kd_bag'];?>"><?=$rowbag['nama_bag'];?></a></td> </td>
<?php				 
...
?>
<!--				
				<tr bgcolor="silver"><td align="right">Sub Total<br></td> 
<?php				 
