...
?>
	Klik <a href="<?php if (isset($_SERVER['HTTP_REFERER'])) {
						echo $_SERVER['HTTP_REFERER'];
					} ?>">disini</a> untuk kembali
<?php
			...
			<div class="dropdown pull-right">
				...
				<ul class="dropdown-menu pull-right" role="menu" aria-labelledby="dropdownMenu1">
					<form role="form" action="edit" method="POST" enctype="multipart/form-data">
						<input type="hidden" name="idd" value="<?php echo $data['no']; ?>">
						<input type="hidden" name="kategori" value="<?php echo $data['kd_kategori']; ?>">
						<input type="hidden" name="aset-detail" value="<?php echo $no; ?>">
						<li role="presentation">&nbsp;&nbsp;&nbsp;&nbsp;<button style="padding: 0; border: none; background:none;" type="submit" name="editaset">Edit Asset</button> </li>
						<li role="presentation">&nbsp;&nbsp;&nbsp;&nbsp;<button style="padding: 0; border: none; background:none;" type="submit" name="auditaset">Audit</button> </li>
					</form>
										...
										<table class="table">
											<tbody>
														...
														<table>
															<tr>
																...
																<td>
																	...
																	<i class="fa fa-long-arrow-right" aria-hidden="true"></i><i class="fa fa-user"></i>
																</td>
																<td>
												...
												<tr>
													...
													<td><?php if ($data['tglreg'] != "0000-00-00") {
															echo tanggal_indo($data['tglreg']);
														} ?></td>
												</tr>
												<tr>
													<td width="150">Tanggal Keluar</td>
													<td><?php if ($data['checkout_date'] != "0000-00-00") {
															echo tanggal_indo($data['checkout_date']);
														}   ?></td>
												</tr>
												<tr>
													<td>Tanggal update</td>
													<td><?php if ($data['update_at'] != "0000-00-00") {
															echo tanggal_indo($data['update_at']);
														}   ?></td>
												</tr>
												<tr>
													<td>Tanggal Audit</td>
													<td><?php if ($data['audit_at'] != "0000-00-00") {
															echo tanggal_indo($data['audit_at']) . " (by " . $data['nama'] . " )";
														}  ?></td>
												</tr>
												<tr>
													<td>Audit Selanjutnya</td>
													<td><?php if ($data['audit_next'] != "0000-00-00") {
															echo tanggal_indo($data['audit_next']);
														}   ?></td>
												</tr>
											</tbody>
										</table>
									...
									<div class="col-md-4">
										...
										<table>
											<tr>
												...
												<td><a href="<?= $data['organik'] ?>?nik=<?= $data['nik'] ?>" title="Detail Aset"><?= $data['nama_karyawan'] ?></a></a></td>
											</tr>
										</table>
										</p>
									...
									<table id="" class="tabledisplay table table-bordered table-striped">
										...
										where no_aset='$no_aset' ");
											while ($row3 = $res3->fetch_assoc()) {
												if (empty($row3['tgl_selesai'])) {
													$selesai = "";
												} else {
													$selesai = tanggal_indo($row3['tgl_selesai']);
												}
												echo '
									<tr>
								...
								<div class="col-md-12">
									...
									<table id="" class="tabledisplay table table-bordered table-striped">
										...
										<tbody>
											...
											while ($row3 = $res3->fetch_assoc()) {
												$date = $row3['tgl'] != "0000-00-00" ? tanggal_indo($row3['tgl']) : "00-00-000";
												echo '
									<tr>
										 <td>' . $date . '</td> 
										 <td>' . $row3['nama'] . '</td>
