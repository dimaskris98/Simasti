...
<?php
if (empty($_GET['no'])){ echo '<section class="content"><div id="webui"><div class="row"><div class="col-md-4"></div>
					<div class="col-md-4 " align="center">
					<p>" No Aset tidak ditemukan "</p>';
?>
					Klik <a href="<?php if(isset($_SERVER['HTTP_REFERER'])){ echo $_SERVER['HTTP_REFERER']; } ?>" >disini</a> untuk kembali
<?php
