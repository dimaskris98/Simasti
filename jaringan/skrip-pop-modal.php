...
<div class="modal" id="popmanufacturer"  role="dialog" aria-labelledby="exampleModalLabel"> 
        <div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" id="exampleModalLabel">Create Manufacturer</h4>
			</div>
		...
		<form class="form-horizontal" method="POST" action="">
					...
					<div class="form-group">
				<div class="col-sm-offset-7 col-sm-5">
					<button type="submit" class="btn btn-primary" data-dismiss="modal" name="Addnewmanufaktur" id="Addnewmanufaktur">Simpan</button>
					<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
					</div>
					<div class="clearfix"> </div>
				</div>
...
<div class="modal" id="popnewkaryawan"  role="dialog" aria-labelledby="exampleModalLabel"> 
		...
		<div class="modal-body">
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<select class="form-control selectpicker" data-live-search="true"  title="Pilih Bagian" name="bagian" id="bagian"    >
										
										<?php 
											$res = $conn->query("SELECT * FROM data_uker_bagian");
											while($row = $res->fetch_assoc()){
												echo '
													<option value="'.$row['kd_bag'].'"> '.$row['nama_bag']. ' </option>
													';
